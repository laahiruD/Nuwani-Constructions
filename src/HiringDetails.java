 ...
 * @author DELL
 */
public class HiringDetails extends javax.swing.JFrame {

    /**
     * Creates new form HiringDetails
     */
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Hiring Details");
        jPanel6.add(jLabel7);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        try {
            ...
            if(a.equals("HiredFrom")){
                ...
                String query1 ="SELECT * FROM `hiring2` WHERE  `Type&Capcity`=?";
                PreparedStatement ps=null;
                ResultSet rs=null;
                ps=databaseConnection.con().prepareStatement(query1);
                ps.setString(1,b);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HiringDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HiringDetails().setVisible(true);
            }
        });
    }
