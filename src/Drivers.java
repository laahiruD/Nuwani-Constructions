...
public class Drivers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EmID", "Name", "Gender", "Adress", "TP ", "Email", "CurrentSite"
            }
        ) {
        ...
        jScrollPane1.setBounds(33, 170, 980, 340);
        ...
        jButton1.setBounds(710, 550, 140, 40);
    ...
    public void DisplayTable() throws SQLException{
        ...
        String query="SELECT * FROM employee WHERE Category='Driver'";
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        try {
            ...
            if(a.equals("EmID")){
                String query1 ="SELECT * FROM `employee` WHERE  `EmID` like 'D%' ";
                PreparedStatement ps=null;
                ResultSet rs=null;
                ...
                String query1 ="SELECT * FROM `employee` WHERE  `CurrentSite`=? AND Category='Driver'";
                PreparedStatement ps=null;
                ResultSet rs=null;
                ps=databaseConnection.con().prepareStatement(query1);
                ps.setString(1,b);
